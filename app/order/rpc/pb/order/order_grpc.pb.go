...
func (c *orderClient) GetOrder(ctx context.Context, in *GetOrderReq, opts ...grpc.CallOption) (*CommonResp, error) {
...
func (c *orderClient) CreateOrder(ctx context.Context, in *CreateOrderReq, opts ...grpc.CallOption) (*CommonResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CommonResp)
...
type OrderServer interface {
	GetOrder(context.Context, *GetOrderReq) (*CommonResp, error)
	CreateOrder(context.Context, *CreateOrderReq) (*CommonResp, error)
...
func (UnimplementedOrderServer) GetOrder(context.Context, *GetOrderReq) (*CommonResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetOrder not implemented")
}
func (UnimplementedOrderServer) CreateOrder(context.Context, *CreateOrderReq) (*CommonResp, error) {
